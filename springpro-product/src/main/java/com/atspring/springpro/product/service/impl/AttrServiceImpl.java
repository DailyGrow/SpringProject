...
import com.atspring.springpro.product.dao.AttrAttrgroupRelationDao;
...
import com.atspring.springpro.product.dao.AttrDao;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public void saveAttr(AttrVo attr) {
        ...
        BeanUtils.copyProperties(attr, attrEntity); //将VO的值封装到PO里
        //1.保存基本数据
    ...
    public AttrRespVo getAttrInfo(Long attrId) {
        ...
        if(attrEntity.getAttrType() == ProductConstant.AttrEnum.ATTR_TYPE_BASE.getCode()){
            //1设置分组信息
            AttrAttrgroupRelationEntity attrAttrgroupRelation = relationDao.selectOne(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_id",attrEntity.getAttrId()));
    ...
    public PageUtils getNoRelationAttr(Map<String, Object> params, Long attrgroupId) {
        ...
        //2.1)当前分类下的其他分组 2.2）这些分组关联的属性 2.3）从当前分类的所有属性中移除这些属性
